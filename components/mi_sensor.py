...
class MiSensor:
    def __init__(self, bt_poller, parameters, cache_timeout=600, force_update=False):
...
class MiTempBtSensor(MiSensor):
    def __init__(self, mac, cache_timeout=600, force_update=False):
        poller = mitemp_bt_poller.MiTempBtPoller(mac=mac, backend=BluepyBackend, cache_timeout=cache_timeout)
        super().__init__(poller, mitemp_parameters, cache_timeout, force_update)
    #
...
class MiFloraSensor(MiSensor):
    def __init__(self, mac, cache_timeout=600, force_update=False):
        ...
        super().__init__(poller, miflora_parameters, cache_timeout, force_update)
